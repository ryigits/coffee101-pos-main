...
router.post("/end", async (req, res) => {
    try {
        ...
        if (req.session.location === "yuzyil") {
...
<html>
  ...
  <body>
    <span class="preheader">${req.session.location} cirosu:${endoftheday.ciro} TL</span>
                ...
                <td class="wrapper">
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td>
                        <p>Gencler,</p>
                        <p>${req.session.location} cirosu:</p>
              ...
              <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td class="content-block">
                    <span class="apple-link">Coffee 101 - OBS Gida Tur Tic Ltd Sti</span>
                    <br>
                  </td>
                </tr>
                <tr>
